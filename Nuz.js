...
+'.scanner-boxSM{ width:130px; height:130px; margin:0; background:url(http://1.bp.blogspot.com/-C-QP8nxJeO8/UU3C_JF0NhI/AAAAAAAACS0/Pr3Jh4DByLg/s1600/scanner-SM.png) top center no-repeat; position:relative;}'
+'.scanner-lineSM{ width:124px; height:20px; background:url(http://4.bp.blogspot.com/-oxQxCPIvkho/UU3C_MgqyqI/AAAAAAAACSw/Cqn_1HaaRZA/s1600/strip-e-SM.png) repeat-x; position:absolute; top:0; left:3px;}'
...
+'<li class="search-identitas-SM 1">User : '+Nama_Login_Anda+'</li>'
